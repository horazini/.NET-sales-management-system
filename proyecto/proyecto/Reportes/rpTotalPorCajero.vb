...
Public Class rpTotalPorCajero
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "proyecto.rpTotalPorCajero.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrpTotalPorCajero
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rpTotalPorCajero = New rpTotalPorCajero()
        rpt.Site = Me.Site
        Return rpt
    End Function
