...
Public Class TotalesParaCajeros
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "proyecto.TotalesParaCajeros.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedTotalesParaCajeros
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As TotalesParaCajeros = New TotalesParaCajeros()
        rpt.Site = Me.Site
        Return rpt
    End Function
